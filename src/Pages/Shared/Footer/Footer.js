                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-5 col-xs-12 about-company">
                            <h2>Learn</h2>
                            <p className="pr-5 text-white-50">Join 31,000+ other and never miss out on new tips, tutorials, and more. </p>
                        ...
                        <div className="col-lg-4 col-xs-12 location">
                            ...
                            <p><i className="fa fa-envelope-o mr-3"></i>info@learn.com</p>
                        </div>
                    </div>
